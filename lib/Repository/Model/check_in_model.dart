...
class CheckinModel {
    ...
    CheckinModel({this.checkInTime, this.checkOutTime, this.collectionId, this.collectionName, this.created, this.date, this.employee, this.halfDayCut, this.hoursWorked, this.id, this.lateComeReason, this.overtimeCheckInTime, this.overtimeCheckOutTime, this.overtimeHours, this.overtimeReason, this.updated});
    ...
    CheckinModel.fromJson(Map<String, dynamic> json) {
        ...
        if(json["hours_worked"] is num) {
            hoursWorked = (json["hours_worked"] as num).toInt();
        }
    ...
    static List<CheckinModel> fromList(List<Map<String, dynamic>> list) {
        return list.map((map) => CheckinModel.fromJson(map)).toList();
    }
